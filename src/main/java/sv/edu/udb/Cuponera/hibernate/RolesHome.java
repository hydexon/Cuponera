 ...
 * @see sv.edu.udb.Cuponera.hibernate.Roles
...
public class RolesHome {
	...
	public Roles findById(java.lang.Integer id) {
		...
		try {
			Roles instance = (Roles) sessionFactory.getCurrentSession().get("sv.edu.udb.Cuponera.hibernate.Roles", id);
			if (instance == null) {
	...
	public List findByExample(Roles instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("sv.edu.udb.Cuponera.hibernate.Roles")
