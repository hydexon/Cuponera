...
public class Clientes {
	...
	public Response addCliente(@FormParam("username") String username, @FormParam("nombres") String nombres, 
		...
		EnviarCorreo.enviarCorreoGmail(c.getCorreo(),
				"Confirmación de usuario " + c.getNombres() + " para cuponera",
				"Su codigo de confirmación es: " +
				"<a href=\"http://localhost:8040/Cuponera/rest/clientes/activacion/"+ cct.getToken() +"\">"+
						cct.getToken()+" (haga clic para confirmar)</a>");
